...
BEGIN
    ...
    */
    ...
    --Rey
    INSERT INTO PIECES_PER_MATCH (PIECES_CODE, MATCHES_ID, "ROW", "COLUMN", COLOR) values ('NR', matchId, 8, 'e', 0);
    --Dama
    INSERT INTO PIECES_PER_MATCH (PIECES_CODE, MATCHES_ID, "ROW", "COLUMN", COLOR) values ('ND', matchId, 8, 'd', 0);
    --Peones
    ...
    */
    ...
    --Rey
    INSERT INTO PIECES_PER_MATCH (PIECES_CODE, MATCHES_ID, "ROW", "COLUMN", COLOR) values ('BR', matchId, 1, 'e', 1);
    --Dama
    INSERT INTO PIECES_PER_MATCH (PIECES_CODE, MATCHES_ID, "ROW", "COLUMN", COLOR) values ('BD', matchId, 1, 'd', 1);
    --Peones
